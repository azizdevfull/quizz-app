    ...
    <section class="bg-white p-5 m-3 rounded">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-5 mt-5">
            ...
            <div class="flex justify-evenly items-center w-96 lg:w-1/3 p-3 m-3 border border-gray-300 rounded">
                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" stroke-width="1.5"
                    viewBox="0 0 24 24" class="w-20 h-20" id="quiz">
                    <g>
                        <path fill="#d0ccff" d="M21.1,14.2l-0.2,0.2C20.3,15,20,15.8,20,16.6v0.3c0,1.7-1.4,3.1-3.1,3.1h-0.3c-0.8,0-1.6,0.3-2.2,0.9l-0.2,0.2
                    ...
                    C18.6,4,20,5.4,20,7.1v0.3c0,0.8,0.3,1.6,0.9,2.2l0.2,0.2C22.3,11,22.3,13,21.1,14.2z"></path>
                        <path fill="#6f51f8"
                            d="M12,4c0.3,0,0.6,0.1,0.8,0.3L13,4.5c1,1,2.2,1.5,3.6,1.5h0.3C17.5,6,18,6.5,18,7.1v0.3c0,1.4,0.5,2.6,1.5,3.6
                        ...
                        C20.3,9,20,8.2,20,7.4V7.1C20,5.4,18.6,4,16.9,4h-0.3c-0.8,0-1.6-0.3-2.2-0.9l-0.2-0.2C13.6,2.3,12.8,2,12,2L12,2z">
                        </path>
                        <path fill="none" stroke="#6f51f8" stroke-linecap="round" stroke-miterlimit="10"
                            stroke-width="2" d="M10,10.6V9.9c0-1,0.8-1.9,1.7-1.9h0.9c1,0,1.7,0.8,1.7,1.9v0c0,0.5-0.2,0.9-0.5,1.2l-1.1,0.7
                    c-0.5,0.3-0.9,0.9-0.9,1.6V14"></path>
                        <path fill="#6f51f8"
                ...
                <a href="{{ route('admin.quizzes.index') }}">
                    <div class="text-center">
                        <h2 class="text-4xl font-bold pb-2">{{ $quizzes_counnt }}</h2>
                        <h4 class="inline text-gray-500 text-md">All quizzes</h4>
                    </div>
                </a>
            </div>
        </div>
